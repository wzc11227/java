...
public class InterfaceSucces extends JDialog implements Observer{
	 ...
	 * Create the frame.
	 */
	public InterfaceSucces(Truc t, String title, Jeu jeu) {
		setModal(true);
		ImageIcon icon;
		...
		lblTuVeuxLe.setBounds(26, 13, 370, 18);
		...
		btnOui.setBounds(171, 213, 113, 27);
